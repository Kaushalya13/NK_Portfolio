...
// --- Social Icons ---
const InstagramIcon = <svg fill="currentColor" className="w-6 h-6" viewBox="0 0 24 24"><path d="M12 2.163c3.204 0 3.584.012 4.85.07 3.252.148 4.771 1.691 4.919 4.919.058 1.265.069 1.645.069 4.85s-.011 3.584-.069 4.85c-.149 3.225-1.664 4.771-4.919 4.919-1.266.058-1.644.07-4.85.07s-3.584-.012-4.85-.07c-3.252-.148-4.771-1.691-4.919-4.919-.058-1.265-.069-1.645-.069-4.85s.011-3.584.069-4.85c.149-3.225 1.664-4.771 4.919-4.919 1.266-.058 1.644-.07 4.85-.07zm0 1.441c-3.141 0-3.506.012-4.724.068-2.697.123-3.91 1.339-4.029 4.029-.056 1.218-.067 1.583-.067 4.724s.011 3.506.067 4.724c.119 2.69 1.332 3.906 4.029 4.029 1.218.056 1.583.067 4.724.067s3.506-.011 4.724-.067c2.697-.123 3.91-1.339 4.029-4.029.056-1.218.067-1.583.067-4.724s-.011-3.506-.067-4.724c-.119-2.69-1.332-3.906-4.029-4.029-1.218-.056-1.583-.067-4.724-.067zm0 5.831a3.566 3.566 0 100 7.132 3.566 3.566 0 000-7.132zm0 5.716a2.15 2.15 0 110-4.3 2.15 2.15 0 010 4.3zm5.716-6.848a.858.858 0 100 1.716.858.858 0 000-1.716z"/></svg>;
const FacebookIcon = <svg fill="currentColor" className="w-6 h-6" viewBox="0 0 24 24"><path d="M18 2h-3a5 5 0 00-5 5v3H7v4h3v8h4v-8h3l1-4h-4V7a1 1 0 011-1h3z"/></svg>;
const TwitterIcon = <svg fill="currentColor" className="w-6 h-6" viewBox="0 0 24 24"><path d="M23 3a10.9 10.9 0 01-3.14 1.53 4.48 4.48 0 00-7.86 3v1A10.66 10.66 0 013 4s-4 9 5 13a11.64 11.64 0 01-7 2c9 5 20 0 20-11.5a4.5 4.5 0 00-.08-.83A7.72 7.72 0 0023 3z"/></svg>;
  ...
  const sendEmail = (e: React.FormEvent<HTMLFormElement>) => {
    ...
    emailjs
      .sendForm(
        ...
        "template_1",     // Replace with your EmailJS template ID
        formRef.current,
        "QILxcvyEa1mV1w0eT" // Replace with your EmailJS public key
      )
      .then(
        () => {
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-start">
          ...
          <div className="space-y-12">
            ...
            <div className="space-y-2">
              <div className="flex items-center space-x-2 text-gray-400">{PhoneIcon}<span>+94 760 578 949</span></div>
              <div className="flex items-center space-x-2 text-gray-400">{EmailIcon}<span>nimanthikaushalya13@gmail.com</span></div>
            </div>
          </div>
